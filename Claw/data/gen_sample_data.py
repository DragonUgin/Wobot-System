...
ROWS = [
    # ---- 玩家：组号 | 姓名 | 备注（示例数据，非真实信息）----
    ["玩家", 1, "张三", "1组"],
    ["玩家", 1, "李四", "1组"],
    ["玩家", 2, "王五", "2组"],
    ["玩家", 2, "赵六", "2组"],

    # ---- NPC：QQ号 | 名字 | 身份（示例数据，非真实信息）----
    ["NPC", 10001, "猎人甲", "hunter"],
    ["NPC", 10002, "猎人乙", "hunter"],
    ["NPC", 10003, "NPC甲", "task_npc"],
    ["NPC", 10004, "机动甲", "mobile"],

    # ---- 任务点：编号|名称|类型|功能卡|NPC_QQ|金露水|静止卡库存|护盾卡库存 ----
    ["任务点", 1, "NPC甲任务点", "solo", "护盾卡", "", 1, 1, 2],  # NPC_QQ列已废弃（线下口头约定）
    ...
    ["线索", 1, "真", 1, "真线索A：目标出现在图书馆三楼", "NPC甲"],
    ["线索", 2, "假", 1, "假线索B：目标已离开校区", "NPC甲"],
    ["线索", 3, "真", 1, "真线索C：目标携带蓝色背包", "NPC甲"],
    ["线索", 4, "真", 1, "真线索D：目标将在东门集合", "NPC甲"],
]
